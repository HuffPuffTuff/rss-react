  ...
  render() {
    ...
    return (
      <form
        ...
        onSubmit={(e) => {
          ...
          updateCards({
            ...
            guarantor: !!guarantorRef.current?.checked,
            delivery: standartDeliveryRef.current?.checked
      ...
      >
        ...
        <label>
          <input type="checkbox" ref={guarantorRef} />
          Sell with a guarantor
        </label>
        <div>
          <p>Creator fee:</p>
          <label>
          ...
          <label>
            <input ref={fastDeliveryRef} type="radio" name="radio" value="maximum" defaultChecked />
            Maximum (10%)
          </label>
        </div>
